...
function DoubleRoom(props) {
    ...
    useEffect(() => {
        async function fetching() {
            try {
                const response = await fetch('http://localhost:1337/double-rooms');
    ...
    return (
        <div style={{ marginTop: 5, padding: 5 }} spacing={3}>
            <p className={classes.title} >Double Room</p>
                                ...
                                <CardActionArea className={classes.CardActionArea}>
                                    <CardContent>
                                        ...
                                        <Typography variant="body2" component="h2">
                                            {room.FullName ? <p>{room.FullName}</p> : <p>Free Room</p>}
                                        </Typography>
                                    </CardContent>
                                </CardActionArea>
                                :
